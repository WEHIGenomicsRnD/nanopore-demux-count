...
def generate_varied_read(read_id, combination_index):
    ...
    # Assemble the read
    sequence = f"{start_random_sequence}{forward_index}{fwd_primer}{middle_random_sequence}{rev_primer}{reverse_index}{end_random_sequence}"
...
with open(fastq_filename, 'w') as fastq_file:
    for read_id in range(1, NUM_READS + 1):
        ...
        fastq_file.write(generate_varied_read(read_id, combination_index))
